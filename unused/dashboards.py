...
def get_dashboards_sc4(sc4):
    ...
    try:
        ...
        result = extra.connect.sc4_connect('dashboard',
                                     'init',
                                     url=url,
                                     token=token,
                                     cookie=cookie)
...
def export_dashboards_sc4(sc4, all=None):
    ...
    try:
        ...
        dashboards = extra.connect.sc4_connect('dashboard',
                                     'init',
                                     url=url,
                                     token=token,
                                     cookie=cookie)
        ...
        if sc4Exportid == "all":
            for v in dashboards['dashboards']:
                input = {'id': v['id']}
                data = extra.connect.sc4_connect('dashboard',
                                           'export',
                                           input,
                                           url=url,
                                           token=token,
    ...
    try:
        ...
        if sc4Import == "all":
            ...
            for v in dashboards:
                ...
                content = extra.connect.sc4_connect('file',
                                              'upload',
                                              url=url,
                                              token=token,
                                              cookie=cookie,
                ...
                extra.connect.sc4_connect('dashboard',
                                    'import',
